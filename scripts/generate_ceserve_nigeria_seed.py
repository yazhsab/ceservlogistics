...
def build_seed(candidates: list[dict[str, str]]) -> str:
    candidate_values = []
...
def main() -> None:
    ...
    args.output.write_text(build_seed(candidates), encoding="utf-8")
    print(f"wrote {args.output} from {len(candidates)} postcode candidates")
