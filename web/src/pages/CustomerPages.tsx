      ...
      <Panel>
        ...
        {query.isLoading ? (
          ...
          <EmptyState
            ...
            description={
              hasPermission("customer.create")
                ? "Adjust the filters or create a customer account."
                : "Adjust the filters or ask an administrator to create the customer. Your role does not allow customer creation."
            }
          />
        ) : (
          <>
